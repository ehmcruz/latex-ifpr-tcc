...
% Adaptado para o Instituto Federal do Paraná por Eduardo Henrique Molina da Cruz
...
% Informações gerais
%
\title{Um Exemplo de Monografia do Instituto Federal do Paraná}
\translatedtitle{An Example of Final Project at Federal Institute of Parana}
...
\renewcommand{\nominataReit}{Prof.~Odacir Antonio Zanatta}
...
\renewcommand{\nominataDir}{Prof.~Jos{\'e} Barbosa Dias J{\'u}nior}
\renewcommand{\nominataDirname}{Diretor do Campus Paranava{\'i}}

\renewcommand{\nominataCoord}{Prof.~Rafael Henrique Dalegrave Zottesso}
\renewcommand{\nominataCoordname}{Coordenador do Curso de Bacharelado em Engenharia de Software}
...
\textbf{Keywords:} list of english keywords.
...
\begin{figure}
    ...
    \begin{center}
        \includegraphics[width=0.7\linewidth]{arvore.jpg}
    \end{center}
    \legend{Fonte: Google Images -- https://www.ecoresponse.com.br/}
    \label{fig:ex1}
\end{figure}
...
\begin{itemize}
    \item \emph{cite}: Unicórnios são verdes \cite{diener2015characterizing};
    \item \emph{citep}:Unicórnios são verdes \citep{diener2015characterizing};
    \item \emph{citet}: Segundo \citet{diener2015characterizing}, unicórnios são
    verdes.
    \item \emph{citen or citenum}: Segundo \citen{diener2015characterizing},
    unicórnios são verdes.
    \item \emph{citeauthor e citeyearpar}: Segundo artigos de
    \citeauthor{diener2015characterizing} , unicórnios são verdes
    \citeyearpar{diener2015characterizing}.
